...
# It will be responsible for handling user input and displaying current GameState object.
...
DIMENSION = 8  # 8x8 squares
SQ_SIZE = HEIGHT // DIMENSION
MAX_FPS = 15  # for animations later on
IMAGES = {}

'''
Initialising a global dict of images. This will be called exactly once in the main.
'''
...
def main():
    ...
    running = True
    sqSelected = ()  # no sq is selected, keeps track of the last click of the user (tuple: (row, col))
